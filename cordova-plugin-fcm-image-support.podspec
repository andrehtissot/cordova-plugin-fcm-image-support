#
#  Be sure to run `pod spec lint cordova-plugin-fcm-image-support.podspec' to ensure this is a
...
DESC
  ...
  spec.homepage     = "https://github.com/andrehtissot/cordova-plugin-fcm-image-support"
  ...
  spec.source       = { :git => "https://github.com/andrehtissot/cordova-plugin-fcm-image-support.git", :tag => "v#{spec.version}" }
